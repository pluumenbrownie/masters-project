\chapter{Ethics and Data Management}\label{edm}
...
\begin{table}[]
  \begin{tabular}{lll}
    \textbf{
      \begin{tabular}[c]{@{}l@{}}Short description
    \end{tabular}} & \textbf{
      \begin{tabular}[c]{@{}l@{}}Availability
    \end{tabular}} & \textbf{
      \begin{tabular}[c]{@{}l@{}}License
    \end{tabular}} \\ \midrule
    All code and datasets & \small https://github.com/pluumenbrownie/masters-project & EUPL 1.2 \\
  \end{tabular}
\end{table}